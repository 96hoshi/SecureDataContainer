...
public class User {
	 ...
	 * 
	 * Rep Invariant: id != null && passw != null && dataCollection.get(i) != null forall i. 0 <= i < dataCollection.size
	 * 
	 * Abstract Function: f(id, password, dataCollection) = <id, passw, {dataCollection.get(0), ..., dataCollection.get(dataCollection.size-1)}>
	 * 
	 */
	
	private String id;
	private String passw;
	private List <SData> dataCollection;
